...
def fileter_content(file):
    ...
    for tag in divTag:
        ...
        for tag in pTags:
            #print(tag.text)
            if(not(tag.parent.get("class") == "comment-content cf") and not(tag.parent.get("class") == "comment-respond")):
                output += tag.text + "\n\n"
...
def copyfile2(src, dst):
    ...
    for line in f.readlines():
		...
		# print(src+'/'+line[:-1])
            ...
            if len(oout) == 0:
                copyfile(copy_me,"/home/icog-labs/singu/" + line)
...
copydirectorykut("/home/icog-labs/AGI-SITES/singu_html","/home/icog-labs/test (2)/Output_Test/singularitytexts")
copyfile2("/home/icog-labs/AGI-SITES/singu_html","/home/icog-labs/test (2)/Output_Test/singularitytexts")
